        ...
        <div class="panel-body">
            <div class="row">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#menu_confidentialite">Confidentialité</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#menu_references">Références</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#menu_resultats">Résultats</a>
                    </li>
                </ul>
            </div>
