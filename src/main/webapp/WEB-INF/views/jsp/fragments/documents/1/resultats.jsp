...
<div class="form-group row">
    <div class="col-xs-12">
        <div class="btn-group">
            <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#res1">Biochimie</button>
            <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#res2">Hématologie</button>
            <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#res3">Cybactériologie urinaire</button>                           
        </div>
    </div>
</div>
<hr>
<div class="form-group row">
    <div class="collapse" id="res1">
        <div class="row">
            <div class="col-xs-12">
