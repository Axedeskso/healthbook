...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user2.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
                    <div class="row"><label>Jorge Mario BERGOGLIO</label></div>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4 class="card-title"><label>Dernire message avant la fin du monde</label></h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user1.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12">
                    <p>Préserver le caractère sacré de la vie humaine contre des humains malades ?</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4 class="card-title"><label>Le Pentagone lance le projet Manhatthan II contre les zones de quarantaine</label></h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user3.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user4.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user5.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user6.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
...
<div class="row">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                <div class="col-xs-1">
                    <img src="<c:url value="/resources/core/img/user7.jpg" />" class="img-responsive">
                </div>
                <div class="col-xs-11">
